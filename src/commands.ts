...
const SPECS: CommandSpec[] = [
  ...
  { id: 'mantra.focusAgent', name: 'focus agent', aliases: ['switch to agent', 'go to agent', 'open agent', 'focus claude', 'switch to claude', 'go to claude', 'open claude', 'focus llm', 'open llm', 'ask agent', 'ask llm'], category: 'terminal' },
